param(
    ...
    [string]$OutputRoot = "D:\\ideaterm\\5g-decrypt-system\\native\\ws-core\\build-nas-minimal",
    [string]$OutputName = "ws_core_nas_minimal.dll",
    [switch]$Clean
)
...
$commonArgs = @(
    ...
    "-DWS_BUILD_DLL",
    "-DENABLE_STATIC",
    "-DWS_CORE_NAS_MINIMAL_BUILD=1"
)

$sources = @(
    "$ConfigRoot\\bridge\\ws_core_nas_bridge.c",
...
Write-Host "Created minimal NAS bridge: $outputBinary"

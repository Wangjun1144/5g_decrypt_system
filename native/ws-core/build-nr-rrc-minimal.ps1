param(
    ...
    [string]$OutputRoot = "D:\\ideaterm\\5g-decrypt-system\\native\\ws-core\\build-nr-rrc-minimal",
    [string]$OutputName = "ws_core_nr_rrc_minimal.dll",
    [switch]$Clean
)
...
$commonArgs = @(
    ...
    "-DWS_BUILD_DLL",
    "-DENABLE_STATIC",
    "-DWS_CORE_NR_RRC_MINIMAL_BUILD=1"
)

$sources = @(
    "$ConfigRoot\\bridge\\ws_core_nr_rrc_bridge.c",
...
Write-Host "Created minimal NR-RRC bridge: $outputBinary"

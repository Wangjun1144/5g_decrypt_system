...
import com.example.procedure.processing.procedure.ruledef.GnBCuInternalHoKeyBits;
import com.example.procedure.processing.procedure.ruledef.GnBCuInternalHoPhases;
...
public class GnBCuInternalHoFlowHandler implements FlowHandler {
    ...
    public ProcedureTypeEnum type() {
        // 纭繚浣犵殑鏋氫妇瀛樺湪璇ョ被鍨嬶紱濡傚懡鍚嶄笉鍚屾寜椤圭洰瀹為檯鏀?

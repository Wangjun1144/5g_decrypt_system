...
public class MessageStageEvent {
    ...
    /**
     * Creates one stage event from the shared message observation snapshot.
     */
    public MessageStageEvent(String stageName, MessageObservationSnapshot snapshot) {
        this(
                stageName,
                snapshot.getCorrelationId(),
                snapshot.getUeId(),
                snapshot.getProcedureId(),
                snapshot.getProcedureTypeCode(),
    ...
    /**
     * Creates one stage event using explicit fields.
     */

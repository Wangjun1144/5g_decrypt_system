 ...
 */
/**
 * Stable input object for the binding stage.
 *
 * It carries:
 * 1. The signaling message being bound.
 * 2. Source metadata inherited from the application ingress layer.
 * 3. Correlation and reentry flags needed by binding events and downstream flow.
 */
public class BindingProcessRequest {
     ...
     */
    public static BindingProcessRequest fromPipelineRequest(SignalingMessageIngressRequest request) {
